    ...
    <>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
          ...
          <p className="font-sans text-soda-lamp/55 max-w-3xl mb-16" style={{ fontSize:'14px', fontWeight:300, lineHeight:1.75 }}>Las historias que se cuentan cuando la noche ya está avanzada</p>
        </motion.div>
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="mb-12">
          <p className="font-sans text-soda-lamp/45" style={{ fontSize:'14px', fontWeight:300, lineHeight:1.75, maxWidth:'38rem' }}>Sodaroja es un proyecto independiente que hacemos con amor, pero también con tiempo, energía y recursos. Cada episodio lleva horas de investigación, edición y producción. Tu aporte nos permite seguir haciéndolo.</p>
        </motion.div>
